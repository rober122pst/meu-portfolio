...
window.aboutArt = `<div class="section-subtitle">
...
function toggleMode(event) {    
    ...
    if (buttonClicked === btnArt) {
        ...
        boxAboutText.innerHTML = window.aboutArt;
        ...
        boxAboutText.innerHTML = window.aboutProgrammer
        ...
        boxAboutText.innerHTML = window.about3d;
        ///////////////TECHS/////////////////
...
window.techsArt = `<h3>Habilidades</h3>
...
function changeSkillsContent(atualMode) {
    ...
    if(atualMode === btnProgrammer) {
        ...
        aboutTechs.innerHTML = window.techsArt;
    }else if(atualMode === btn3d) {
        aboutTechs.innerHTML = window.techs3d;
    }
}
...
function changeProjectsContent(atualMode) {
    ...
    if(atualMode === btnProgrammer) {
        ...
        textProjects.innerHTML = window.projectsArtsHtml;
    }else if(atualMode === btn3d) {
        textProjects.innerHTML = window.projects3dHtml;
    }
}
